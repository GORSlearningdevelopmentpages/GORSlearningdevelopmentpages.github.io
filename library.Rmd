...
Also, if you would like to explore the official guidance on quality assurance and producing quality analysis for government, please refer to the [Aqua Book](https://www.gov.uk/government/publications/the-aqua-book-guidance-on-producing-quality-analysis-for-government). The Aqua Book is one of the products developed by the cross-departmental working group on analytical quality assurance and is a good practice guide to those working with analysis and analytical models.
...
[**Excel: foundation**](https://learn.civilservice.gov.uk/courses/PHP-Qf-ZS2CClCfkGDXLGQ) <br>
**Type:** Online <br>
**Source:** Civil Service Learning <br>
**Time:** 7 days <br>
**Price:** Free <br>
**Description:** Provides help if you're new to working with spreadsheets and want to improve your basic skills.

[**Excel: intermediate**](https://learn.civilservice.gov.uk/courses/CmVXrBiFRzO7L_566Ov_Tg) <br>
**Type:** Face to face <br>
**Source:** Civil Service Learning <br>
**Time:** 7 hours <br>
**Price:** £299 (ex VAT) <br>
**Description:** Take your Excel skills to the next level by attending this workshop.

[**Excel: advanced**](https://learn.civilservice.gov.uk/courses/Puj-BFZ_QHaqshcEtD_UpQ) <br>
**Type:** Face to face <br>
**Source:** Civil Service Learning <br>
**Time:** 7 hours <br>
**Price:** £472 (ex VAT) <br>
**Description:**  Explore the advanced features and benefits of Excel and learn how to use them effectively.
