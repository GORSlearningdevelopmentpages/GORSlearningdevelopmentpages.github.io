...
data_gen <- data %>% filter(category == "General Analytics") %>% filter(duplicated(course)==F)
...
data_gen_prof <- data %>% filter(category == "General Professional") %>%filter(duplicated(course)==F)
for (i in 1:nrow(data_gen_prof)){
  cat(paste0(" \n**",data_gen_prof[i,1],"** \n"))
  cat(paste0(" \n* ",data_gen_prof[i,5]," \n"))
  cat(paste0(" \n* ",data_gen_prof[i,6]," \n"))
  cat(paste0(" \n* ","More info: ",data_gen_prof[i,7]," \n"))
cat(paste0(" \n","........."," \n"))
}
