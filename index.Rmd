...
## L&D Library
Our [L&D Library](library.html) is a database of curated courses that cover various topics which fall under the remit of a typical operational researcher. Here we cover:
...
## FAQs
Our [FAQs](faq.html) page answers some of those niggling questions you may have about GORS and it's L&D approach. Here we cover:
...
::: {.warning}
If you have any suggestions for these pages, questions about L&D, would like to run an internal course for GORS members, or would like to get involved with our group please get in touch with us: [GORS-LD@justice.gov.uk](mailto:gors-ld@justice.gov.uk)
:::
