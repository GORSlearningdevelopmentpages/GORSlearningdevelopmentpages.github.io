...
**A:** See our document on how to book an external course: [GORS Guide to booking an external courses](files/GORS Guide to booking an external course v2.0.pptx)
...
**A:** The following template is endorsed by GORS CMU: [GORS CPD Log](files/GORS_CPD_Log.xlsm).
